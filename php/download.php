...
$dodozip -> createfile();
echo "<br>压缩完成,共添加$filenum个文件.<br><ahref='$_REQUEST[todir]$_REQUEST[zipname]'_fcksavedurl='$_REQUEST[todir]$_REQUEST[zipname]'>$_REQUEST[todir]$_REQUEST[zipname](".num_bitunit(filesize("$_REQUEST[todir]$_REQUEST[zipname]")).")</a>";
}
else
{
...
<hr color="#003388">
<center>
<ahref="http://hi.baidu.com/ca3tie1/home"target="_blank">Ca3tie1'sBlog</a>
</center>
</body>  
</html>
